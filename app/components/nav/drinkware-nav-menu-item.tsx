...
export default function DrinkwareMenuItem() {
  return (
    <NavigationMenu.Item>
      ...
      <NavigationMenu.Content className="data-[motion=from-start]:animate-enterFromLeft data-[motion=from-end]:animate-enterFromRight data-[motion=to-start]:animate-exitToLeft data-[motion=to-end]:animate-exitToRight absolute top-0 left-0 w-full sm:w-auto">
        <ul className="one m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[500px] sm:grid-cols-[0.75fr_1fr]">
          <NavListItem href="/drinkware/bottles" title="Bottles">
            Bottles that fit your style. And your bag. And your life.
          </NavListItem>
          ...
          <NavListItem href="/drinkware/mugs" title="Mugs">
            Mugs to empower your mornings. And your evenings. And your nights.
          </NavListItem>
          <NavListItem href="/drinkware/tumblers" title="Tumblers">
